 ...
 */
 ...
 const ETHSCANAPIKEY = fs.readFileSync(".maticapikey").toString();
 ...
 module.exports = {
   ...
   networks: {
    ...
    oec_test: {
      provider: () => new HDWalletProvider(mnemonic, `https://exchaintestrpc.okex.org`),//https://exchaintestrpc.okex.org
      network_id: 65,
      confirmations: 10,
      timeoutBlocks: 200,
      skipDryRun: true
